...
public class WeirdList {
  ...
  public WeirdList(int head, WeirdList tail) {
    ...
    private static class WeirdEmpty extends WeirdList {
        public WeirdEmpty(int head, WeirdList tail){
            super(head, tail);
        }
        @Override
        public int length(){
        ...
        @Override public WeirdList map(IntUnaryFunction func){
            return this;
        }
